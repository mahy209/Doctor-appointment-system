<?php
	...
	$result = getAll($conn);
?>
	<p class="lead"><a href="admin_add.php" class="btn btn-primary btn-md col-sm-2">Add new book</a></p>
	<a href="admin_signout.php" class="btn btn-primary btn-md" style="float:right">Sign out!</a>
